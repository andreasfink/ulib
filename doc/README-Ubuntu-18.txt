...
(run as root or use sudo in front)
  apt-get install build-essential git subversion ninja-build \
        ...
        libc-dev libc++-dev \
        python-dev swig \
        libedit-dev libeditline0  libeditline-dev libreadline7 libreadline-dev readline-common \
        ...
        libgif7 libwings3 libwraster6 libwutil5 libxmu6 libxpm4 wmaker-common
        llvm-10 clang-10 lldb-10 libclang-10-dev \
        cmake  gobjc++\
        xorg \
